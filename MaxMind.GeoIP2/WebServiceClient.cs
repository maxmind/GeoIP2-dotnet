...
namespace MaxMind.GeoIP2
{
    ...
    ///         accountId and licenseKey, then you call the method corresponding
    ...
    public class WebServiceClient : IGeoIP2WebServicesClient, IDisposable
    {
        ...
        public WebServiceClient(int accountId, string licenseKey, string host = "geoip.maxmind.com", int timeout = 3000)
            : this(accountId, licenseKey, new List<string> { "en" }, host, timeout)
        {
        }
        ...
        /// <param name="host">The host to use when accessing the service</param>
        /// <param name="timeout">Timeout in milliseconds for connection to web service. The default is 3000.</param>
        public WebServiceClient(int accountId, string licenseKey, IEnumerable<string> locales,
            string host = "geoip.maxmind.com",
            int timeout = 3000) : this(accountId, licenseKey, locales, host, timeout, null)
        {
        }
